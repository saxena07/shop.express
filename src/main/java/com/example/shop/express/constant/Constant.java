package com.example.shop.express.constant;

public final class Constant {

    public static final String PROVIDE_ALL_PRODUCT_DETAILS = "provide_all_product_fields";
    public static final String PROVIDE_ALL_CATEGORY_DETAILS = "provide_all_category_details";
